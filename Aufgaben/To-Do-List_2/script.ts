 ...
 * den ToDo-Text und den donestatus eines ToDos. Die entsprechende
...
var todoliste: Todolisteintrag [] = [
    {
        todoText: "This is a noice cornfield",
        todosChecked: true
    },
    {
        todoText: "Look at all those chickens",
        todosChecked: false
    },
    {
        todoText: "I wanna be a cowboy, baby",
        todosChecked: false
    }
];
/**
...
function updateCounter(): void {
    ...
    doneDOMElement.innerHTML = watched + " watched";
    openDOMElement.innerHTML = notwatched + " not watched";
}
